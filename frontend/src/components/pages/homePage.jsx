            ...
            <div className='grid place-items-center grid-cols-1 sm:grid-cols-2'>
                <div
                     ...
                     className='order-1 sm:order-2'>
                      <img src= {theme === "dark"? sm1Car : gwagon}  alt="car" className='
                                                                                     max-h-[600px] 
                                                                                     sm:scale-125 
                ...
                <div className='order-2 sm:order-1 space-y-5 sm:pr-32'>
                    <p 
                        ...
                        text-2xl font-serif '> Smooth-Motion
                    </p>   {/* Smooth Transit */}
                    <h1 
                      data-aos="fade-up"
                      data-aos-delay="600"
                      className='text-4xl lg:text-7xl font-semibold font-serif'>Car Rental
                    </h1>
                    ...
                    <button 
                      className='btn bg-primary text-black px-6 py-2 rounded-md hover:bg-primary/85 duration-300 mt-6'>
                        Get Started
                    </button>
                    </div>
